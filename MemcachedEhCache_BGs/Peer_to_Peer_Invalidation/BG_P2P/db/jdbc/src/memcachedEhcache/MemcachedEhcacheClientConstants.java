 ...
 *
 */
public interface MemcachedEhcacheClientConstants {
	...
	public static final String MAX_CACHE_MEMORY_DEFAULT = "10";
	...
	/** The name of the property for the memcached server host name. */
	public static final String MEMCACHED_SERVER_HOST_DEFAULT="192.168.137.97";
	
	/** The name of the property for the memcached server port. */
	public static final String MEMCACHED_SERVER_PORT_DEFAULT="11211";
	
	/** The name of the property for the memcached server host name. */
	public static final String INVALIDATION_SERVER_HOST_DEFAULT="192.168.137.97";
	
	/** The name of the property for the memcached server port. */
	public static final String INVALIDATION_SERVER_PORT_DEFAULT="11212";
	
	/** The name of the property for the memcached server port. */
	public static final String LOCAL_MEMCACHEDEHCACHE_SERVER_PORT_DEFAULT="9872";
