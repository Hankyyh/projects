...
public class MemcachedEhcacheClient extends DB implements MemcachedEhcacheClientConstants {
	...
	public int acceptFriend(int inviterID, int inviteeID) {
		...
		try {
			...
			if(isInsertImage)
			{
				...
				if(!common.MemcachedEhCacheUtilities.CacheDelete(cacheclient, key))
				{
	...
	public int viewProfile(int requesterID, int profileOwnerID,
		...
		try {
			...
			{
				payload = common.MemcachedEhCacheUtilities.CacheGet(cacheclient,key, this.compressPayload);
		...
		try 
		{
			if(!common.MemcachedEhCacheUtilities.CacheSet(cacheclient,key, payload, this.compressPayload))
			{
	...
	public int listFriends(int requesterID, int profileOwnerID,
		...
		try 
		{
			...
			{
				byte[] payload = common.MemcachedEhCacheUtilities.CacheGet(cacheclient,key, this.compressPayload);
				if (payload != null){
					if (verbose) System.out.println("... Cache Hit!");
