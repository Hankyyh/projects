...
public class MemcachedEhCacheUtilities {
	...
	public static byte[] CacheGet(RemoteCacheClient cacheclient, String key, boolean compressPayload)
	{
		byte[] result = null;
		int numRetries = 0;
		...
		{
			try {
				result = MemcachedEhCacheUtilities.decompressBytes(result);
	...
	public static boolean CacheSet(RemoteCacheClient cacheclient, String key, byte[] payload, boolean compressPayload)
	{	
		if(payload != null && compressPayload)
		{
			try {
				payload = MemcachedEhCacheUtilities.compressBytes(payload);
			} catch (UnsupportedEncodingException e) {
				// TODO Auto-generated catch block
				e.printStackTrace(System.out);
				return false;
		...
		return cacheclient.set(key, payload);
	}
	
	public static boolean CacheDelete(RemoteCacheClient cacheclient, String key)
	{
