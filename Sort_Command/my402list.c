...
{
//    My402ListElem *anchor = &(my402list->anchor);
//	My402ListElem *lastElement = My402ListLast(my402list);
//    
//	if(lastElement == NULL)//if its an anchor
//	{
//		lastElement = anchor;
//	}
//    
//	My402ListElem *newListElement = (My402ListElem*) malloc(sizeof(My402ListElem));
//	if(newListElement == 0){//memory overflow
//		return FALSE;
//	}
//	else{
//		newListElement->obj = object;
//		lastElement->next = newListElement;
//		newListElement->next = anchor;
//		newListElement->prev = lastElement;
//		anchor->prev = newListElement;
//        
...
//		newListElement->obj = object;
//        
//		anchor->next = newListElement;
//		newListElement->next = firstElement;
//		newListElement->prev = anchor;
//		firstElement->prev = newListElement;
//        
//		my402list->num_members++;
//		return TRUE;
//	}
