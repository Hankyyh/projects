...
struct amountChk(char* transactionamount)
{
    
   // char *amt[2];                //to keep dollars n cents separate..//
    char *dollar, *cents;
    //int amount;
    
    int flag = 0;
    //int check=0;        //for first part of string
    
    checking abc=(checking)malloc(sizeof(checking));
...
int Read_input(FILE* fp,My402List* my402list)
{
    ...
    while (fgets(buf,sizeof(buf),fp)!=NULL)
    {
        ...
        checking amount=amountChk(transactionamount);
